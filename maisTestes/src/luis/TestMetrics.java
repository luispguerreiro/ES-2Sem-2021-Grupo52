...
public class TestMetrics {
	...
	public TestMetrics() throws FileNotFoundException {
		...
		for (Metrics m : metrics) {
			for (int i = 0; i < m.getNumOfMethods(); i++) {
				System.out.println("Class: " + m.getClassName() + " tem NOM_Class = " + m.getNumOfMethods()
						+ ", WMC_Class = " + m.getCYCLO_Class() + ", LOC_Class = " + m.getLOC_Class() + " || Metodo: "
						+ m.getMethodsName().get(i) + " CYCLO_Method = " + m.getCYCLO_Method_Results().get(i)
